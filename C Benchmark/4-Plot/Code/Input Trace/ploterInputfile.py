...
fig.update_layout(title_text="Memory accesses before using ORAM",title_font_size=30)
fig.update_xaxes(title="Memory Addresses")
fig.update_yaxes(title="Accesses")
plotly.offline.plot(fig, filename='Memory Input'+'.html',auto_open=False)	  	
fig.show()
